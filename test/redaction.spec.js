...
const { MobilettoOrmTypeDef } = require("../index")
...
describe('redaction test', async () => {
    it("successfully redacts a complex typedef", async () => {
        ...
        expect(redacted.nestedObject.triplyNestedObject.nested3Plain).eq(thing.nestedObject.triplyNestedObject.nested3Plain)
