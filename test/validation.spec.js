...
describe("validation test", async () => {
  ...
  it("fails to create an object with a too-small field", async () => {
    try {
      ...
      expect(e.errors["int"][0]).equals(
        "minValue",
        "expected int.minValue error"
      );
    }
  });
  ...
  it("fails to create an object with a regex-failing field", async () => {
    try {
      ...
      expect(Object.keys(e.errors).length).equals(1, "expected 1 error");
      expect(e.errors["alphaOnly"].length).equals(
        1,
        "expected 1 alphaOnly error"
      );
      expect(e.errors["alphaOnly"][0]).equals(
        "regex",
        "expected alphaOnly.regex error"
      );
    }
  });
  it("fails to create an object where a value is not one of a specific set", async () => {
    try {
      ...
      expect(Object.keys(e.errors).length).equals(1, "expected 1 error");
      expect(e.errors["restricted"].length).equals(
        1,
        "expected 1 restricted error"
      );
      expect(e.errors["restricted"][0]).equals(
        "values",
        "expected restricted.values error"
      );
    }
  });
  it("fails to create an object where a field is not required but has a minimum length, and the value too short", async () => {
    try {
      ...
      expect(Object.keys(e.errors).length).equals(1, "expected 1 error");
      expect(e.errors["notRequiredButHasMin"].length).equals(
        1,
        "expected 1 notRequiredButHasMin error"
      );
      expect(e.errors["notRequiredButHasMin"][0]).equals(
        "min",
        "expected notRequiredButHasMin.min error"
      );
    }
  });
  ...
  it("fails to create an object with multiple type errors", async () => {
    try {
      ...
      expect(e.errors["alphaOnly"][0]).equals(
        "type",
        "expected alphaOnly.type error"
      );
      expect(e.errors["comments"].length).equals(
        1,
        "expected 1 comments error"
      );
      expect(e.errors["comments"][0]).equals(
        "type",
        "expected comments.type error"
      );
      expect(e.errors["impliedBoolean"].length).equals(
        1,
        "expected 1 impliedBoolean error"
      );
      expect(e.errors["impliedBoolean"][0]).equals(
        "type",
        "expected impliedBoolean.type error"
      );
      expect(e.errors["restricted"].length).equals(
        1,
        "expected 1 restricted error"
      ...
      expect(e.errors["restricted"][0]).equals(
        "type",
        "expected restricted.type error"
      );
    }
  });
