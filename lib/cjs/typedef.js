...
class MobilettoOrmTypeDef {
    constructor(config) {
        ...
        this.indexLevels = config.debug ? 0 : config.indexLevels ? config.indexLevels : constants_js_1.DEFAULT_ID_INDEX_LEVELS;
        this.fields = config.fields || {};
        this.apiConfig = config.apiConfig || constants_js_1.DEFAULT_API_CONFIG;
        this.indexes = [];
        this.redaction = [];
        ...
        this.specificPathRegex = new RegExp(`^${this.typeName}_.+?${hash_js_1.OBJ_ID_SEP}${constants_js_1.VERSION_PREFIX}[a-z]{2,12}_[\\da-f]{12}_[\\da-f]{12}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{12}.json$`, "gi");
        this.idRegex = (0, hash_js_1.idRegex)(this.idPrefix);
    ...
    newId() {
        return (0, hash_js_1.generateId)(this.idPrefix);
    }
    versionPrefix() {
    ...
    validate(thing, current) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, validation_js_1.validateFields)(thing, thing, this.fields, current, validated, this.validators, errors, "");
    ...
    id(thing) {
        ...
        if (this.idPrefix && foundId) {
            const minIdLength = hash_js_1.MIN_ID_LENGTH + this.idPrefix.length;
    ...
    specificBasename(obj) {
        ...
        return this.typeName + "_" + this.id(obj) + hash_js_1.OBJ_ID_SEP + obj._meta.version + ".json";
    }
    idFromPath(p) {
        // start with basename
    ...
    indexPath(field, value) {
        ...
        if (this.indexes.filter((i) => i.field === field).length > 0) {
            ...
            return `${this.typePath()}_idx_${(0, hash_js_1.typedefHash)(field, this.debug)}/${(0, hash_js_1.typedefHashDirs)(value, this.debug, indexLevels)}`;
        }
        else {
