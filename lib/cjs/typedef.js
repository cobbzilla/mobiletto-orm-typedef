...
class MobilettoOrmTypeDef {
    ...
    validate(thing, current) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, validation_js_1.validateFields)(thing, thing, this.fields, current, validated, this.validators, errors, "", this.registry);
    ...
    id(thing) {
        ...
        if (thing._meta && typeof thing._meta.id === "string") {
            ...
            if (this.shortName && !foundId.startsWith(this.shortName)) {
                this.log_warn(`id: provided _meta.id did not start with ${this.shortName}, discarding: ${thing._meta.id} (normalized to ${foundId})`);
                foundId = null;
            }
        }
