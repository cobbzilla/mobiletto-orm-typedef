...
class MobilettoOrmTypeDef {
    ...
    generalPath(id) {
        ...
        return this.typePath() + "/" + (0, util_js_1.typedefHashDirs)(idVal, this.debug, this.indexLevels);
    }
    isSpecificPath(p) {
    ...
    indexPath(field, value) {
        ...
        if (this.indexes.filter((i) => i.field === field).length > 0) {
            ...
            return `${this.typePath()}_idx_${(0, util_js_1.typedefHash)(field, this.debug)}/${(0, util_js_1.typedefHashDirs)(value, this.debug, indexLevels)}`;
        }
        else {
