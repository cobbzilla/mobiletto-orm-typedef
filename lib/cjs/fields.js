...
exports.processFields = exports.FIELD_NAME_REGEX = exports.determineFieldType = exports.determineFieldControl = void 0;
...
const determineFieldControl = (fieldName, field, fieldType) => {
    ...
    if ((0, constants_js_1.isArrayType)(fieldType)) {
...
const determineFieldType = (fieldName, field) => {
    ...
    const isArray = (0, constants_js_1.isArrayType)(field.type);
    ...
    if (defaultType !== "undefined") {
        if (field.type && (0, constants_js_1.isArrayType)(field.type)) {
    ...
    if (hasValues || hasItems) {
        ...
        if (!isMulti && !(0, constants_js_1.isArrayType)(field.type)) {
        ...
        else if (isMulti && foundType && !(0, constants_js_1.isArrayType)(foundType)) {
            foundType += "[]";
        }
    }
    ...
    if (foundType) {
        ...
        if (isMulti && foundType && !(0, constants_js_1.isArrayType)(foundType)) {
            return (foundType + "[]");
        }
        return foundType;
    }
