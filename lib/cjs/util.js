...
exports.rand = exports.MIN_ID_LENGTH = exports.idRegex = exports.generateId = exports.sha = exports.fsSafeName = void 0;
...
const idRegex = (prefix) => new RegExp(`^${prefix ? prefix + "_" : ""}[a-f\\d]{12}_[\\da-f]{12}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{12}$`, "gi");
