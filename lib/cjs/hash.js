...
exports.rand = exports.MIN_ID_LENGTH = exports.idRegex = exports.generateId = exports.typedefHashDirs = exports.shaLevels = exports.insertAtIndex = exports.typedefHash = exports.sha = exports.OBJ_DIR_SUFFIX = exports.OBJ_ID_SEP = exports.fsSafeName = void 0;
...
const shaLevels = (val, levels) => {
    let s = (0, exports.sha)(`${val}`);
    if (levels > 0) {
        for (let i = 0; i < levels; i++) {
            s = (0, exports.insertAtIndex)(s, "/", 2 + 3 * i);
        }
    }
    return s;
};
exports.shaLevels = shaLevels;
const typedefHashDirs = (val, debug, levels) => {
    if (debug)
        return `${val}${exports.OBJ_DIR_SUFFIX}`;
    const s = (0, exports.shaLevels)(val, levels);
