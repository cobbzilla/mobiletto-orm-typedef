...
const validateFields = (rootThing, thing, fields, current, validated, validators, errors, objPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const fieldName of Object.keys(fields)) {
        ...
        if (field.type === "object") {
            if (field.required && thingValueType !== "object") {
                ...
                yield (0, exports.validateFields)(rootThing, thing[fieldName], field.fields, currentValue, validated[fieldName], validators, errors, fieldPath);
            }
            continue;
        }
