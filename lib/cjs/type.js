...
class MobilettoOrmTypeDef {
    constructor(config) {
        ...
        this.alternateIdFields =
            config.alternateIdFields || constants_js_1.DEFAULT_ALTERNATE_ID_FIELDS;
    ...
    defaultFieldValue(field, opts) {
        ...
        if (field.type === "string")
            return dummy
                ? randomstring_1.default.generate(Math.ceil(Math.random() * (field.max ? field.max : 10)))
                : "";
    ...
    validate(thing, current) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof thing.version !== "string" ||
                thing.version.length < constants_js_1.MIN_VERSION_STAMP_LENGTH) {
