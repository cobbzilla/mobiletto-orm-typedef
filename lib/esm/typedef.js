...
import { basename, DEFAULT_ALTERNATE_ID_FIELDS, DEFAULT_API_CONFIG, DEFAULT_FIELD_INDEX_LEVELS, DEFAULT_ID_INDEX_LEVELS, DEFAULT_MAX_VERSIONS, DEFAULT_MIN_WRITES, VERSION_PREFIX, } from "./constants.js";
...
export class MobilettoOrmTypeDef {
    ...
    validate(thing, current, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield validateFields(thing, thing, this.fields, current, validated, this.validators, errors, "", checkRefs ? this.registry : undefined);
