...
import { fsSafeName, generateId, MIN_ID_LENGTH, rand, sha } from "./util.js";
import { normalized, compareTabIndexes, } from "./field.js";
import { DEFAULT_ALTERNATE_ID_FIELDS, DEFAULT_MAX_VERSIONS, DEFAULT_MIN_WRITES, OBJ_ID_SEP, } from "./constants.js";
...
const ID_PREFIX_REGEX = /^[a-z]{2,12}$/g;
...
export class MobilettoOrmTypeDef {
    constructor(config) {
        ...
        this.specificPathRegex = new RegExp(`^${this.typeName}_.+?${OBJ_ID_SEP}v_[a-z]{2,12}_[\\da-f]{12}_[\\da-f]{12}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{12}.json$`, "gi");
